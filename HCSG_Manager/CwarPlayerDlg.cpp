...
BEGIN_MESSAGE_MAP(CCwarPlayerDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON_GET_AWARDS_LIST, &CCwarPlayerDlg::OnBnClickedButtonGetAwardsList)
	ON_BN_CLICKED(IDC_BUTTON_SEDN_AWARDS, &CCwarPlayerDlg::OnBnClickedButtonSednAwards)
END_MESSAGE_MAP()
...
void CCwarPlayerDlg::OnBnClickedButtonGetAwardsList()
{
	// TODO:  在此添加控件通知处理程序代码
	GetHores();
}
...
void CCwarPlayerDlg::OnBnClickedButtonSednAwards()
{
	// TODO:  在此添加控件通知处理程序代码
	PaymentOfAwards();
}
