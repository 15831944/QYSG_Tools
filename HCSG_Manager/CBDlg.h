...
class CCBDlg : public CDialogEx
{
	DECLARE_DYNAMIC(CCBDlg)

public:
	CCBDlg(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CCBDlg();

// 对话框数据
	enum { IDD = IDD_DIALOG_CB };
...
public:
	...
	afx_msg void OnEnChangeEditMapCb();
	CEdit m_CEditMapPath;
	afx_msg void OnBnClickedButtonGetAwardsList();
	afx_msg void OnBnClickedButtonSednAwards();
};
